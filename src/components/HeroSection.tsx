        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <h1 className="text-5xl lg:text-6xl font-bold text-gray-800 leading-tight">
                  Монтируем 
                  <span className="text-blue-600 block">как надо</span>
                </h1>
            ...
            <div className="relative">
                ...
                <div className="aspect-square bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl flex items-center justify-center">
                  <div className="text-center space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-blue-600 font-medium">Лицензии • НДС • Документооборот</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-blue-600/10 rounded-full"></div>
              <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-blue-600/20 rounded-full"></div>
            </div>
          </div>
        </div>
      </div>
